    ...
    params: {
      ...
      toppings: {
        ...
        options: {
          ...
          redPeppers: {label: 'Red peppers', price: 4, default: true},
          greenPeppers: {label: 'Green peppers', price: 5, default: true},
          mushrooms: {label: 'Mushrooms', price: 6, default: true},
          basil: {label: 'Fresh basil', price: 7, default: true},
  ...
  salad: {
    ...
    params: {
      ingredients: {
        ...
        type: 'checkboxes',
        options: {
          cucumber: {label: 'Cucumber', price: 2, default: true},
          tomatoes: {label: 'Tomatoes', price: 1, default: true},
          olives: {label: 'Olives', price: 3, default: true},
          feta: {label: 'Feta cheese', price: 4},
          cheese: {label: 'Cheese', price: 5},
          herbs: {label: 'Fresh herbs', price: 6, default: true},
          pepper: {label: 'Black pepper', price: 7},
        },
      },
    },
  },
