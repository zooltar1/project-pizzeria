    ...
    params: {
      ...
      toppings: {
        ...
        options: {
          ...
          redPeppers: {label: 'Red peppers', price: 1, default: true},
          greenPeppers: {label: 'Green peppers', price: 1, default: true},
          mushrooms: {label: 'Mushrooms', price: 1, default: true},
          basil: {label: 'Fresh basil', price: 1, default: true},
          salami: {label: 'Salami', price: 1},
        },
      },
      crust: {
        label: 'pizza crust',
        ...
        options: {
          ...
          cheese: {label: 'cheese in edges', price: 2},
          wholewheat: {label: 'wholewheat', price: 2},
